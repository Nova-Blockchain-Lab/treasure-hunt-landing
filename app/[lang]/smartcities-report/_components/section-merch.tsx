...
export function SectionMerch({ snapshot }: { snapshot: Snapshot }) {
  ...
  // Sort SKUs by the current mode. Default = total units claimed, which
  // rewards items that moved real inventory rather than tiny novelty stock
  // that vanished in a minute. Velocity / sellout / stock are alternate
  // lenses, but each has the same trinket-skew the user explicitly flagged.
  ...
  // Top-10 leaderboard buyers vs everyone else — drives the visual
  // conclusion under the scatter. If the top 10 ranks bought a small share
  // of all merch, the merch race wasn't the leaderboard race.
      ...
      <div className="report-container">
        ...
        >
          ...
          <div className="report-card">
            ...
            {/* Strong visual conclusion: the leaderboard top-10 captured a
                minority of merch. The on-chain claim rate-limit kept the
                distribution incredibly fair. */}
            <div
              style={{
                marginTop: 18,
                padding: "18px 20px",
            ...
            >
              ...
              >
                <strong style={{ color: "#56D364" }}>
                  Merch distribution at PSCS 2026 was incredibly fair.
                </strong>{" "}
