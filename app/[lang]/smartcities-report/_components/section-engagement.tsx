...
export function SectionEngagement({ snapshot }: { snapshot: Snapshot }) {
  const { socials, hourGridAbs } = snapshot
    ...
    <section className="report-section" id="engagement">
      <div className="report-container">
        <Anchor
          ...
          lede="Where players posted across the three days, and how their attention rose and fell hour by hour."
        />
        ...
        <div className="report-card">
          ...
          >
            <HourLineChart absCounts={hourGridAbs} height={460} />
          </ChartFrame>
        </div>
      </div>
    </section>
