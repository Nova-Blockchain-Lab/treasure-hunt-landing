        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: `7 teams, 20 hunters, 220 treasures found across ${TREASURE_POPULARITY.length} tags. Full analytics from the ${TOKEN_NAME} Teams Hunt at NOVA IMS.`,
              datePublished: EVENT_DATE,
              url: 'https://www.treasurehunt.pt/springbootcamp-report',
              mainEntityOfPage: 'https://www.treasurehunt.pt/springbootcamp-report',
