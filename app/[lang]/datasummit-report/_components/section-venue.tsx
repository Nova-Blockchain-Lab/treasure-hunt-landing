...
import { fmtInt } from "@/lib/datasummit-report"
    ...
    <section className="report-section" id="venue">
      <div className="report-container">
        <Anchor
          num="02"
          title="VENUE"
          lede="Kernel-density of every NFC find, overlaid on the real Taguspark Data with Purpose Summit floor plan."
        />
        <div
          style={{
            display: "flex",
      ...
      <div className="report-container" style={{ marginTop: 24 }}>
        ...
        >
          ...
          at a tag. The venue has no fixed booth sectors — players hid their
          own tags across the venue, so the heatmap traces the
