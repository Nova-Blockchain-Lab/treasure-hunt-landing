...
import type { ReportHotspot } from "@/lib/datasummit-report"

// Taguspark venue map is the official Taguspark campus site map, landscape.
// Source: public/datasummit-venue-map.png @ 1517 × 1600. Heat-blob math reads point
...
export function VenueMap({ hotspots }: { hotspots: ReportHotspot[] }) {
  return (
    <svg
      ...
      role="img"
      aria-label="Taguspark Data with Purpose Summit venue map with a weather-map style kernel-density heatmap of treasure-hunt finds."
    >
      <image
        href="/datasummit-venue-map.png"
        x={0}
        y={0}
        width={VW}
        height={VH}
