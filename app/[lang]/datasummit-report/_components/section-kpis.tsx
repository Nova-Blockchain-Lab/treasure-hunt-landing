...
import type { Snapshot } from "@/lib/datasummit-report"
import { fmtPct } from "@/lib/datasummit-report"
...
export function SectionKPIs({ snapshot }: { snapshot: Snapshot }) {
  ...
  const items: Array<{
    ...
    },
    {
      value: tagsHidden,
      label: "Tags hidden",
      hint: "NFC tags concealed across the venue by players and organisers.",
    },
    {
    ...
    },
    {
      ...
      hint: "On-chain claims of physical merch from the summit store.",
    },
  ]
    ...
    <section className="report-section" id="headline">
      <div className="report-container">
        <Anchor
          num="01"
          title="HEADLINE"
          lede="Five numbers, snapshot at end of the summit. Every figure is verifiable on-chain — the contract address is in the footer."
        />
        <div
          style={{
            display: "grid",
