        ...
        <div className="report-colophon">
          ...
          <div className="report-colophon__row">
            <div className="report-colophon__item">
              {/* DwP checkerboard logo needs a light backing to read (see CLAUDE.md) */}
              <Image
                src="/datasummit-logo.svg"
                alt="Data with Purpose Summit · Taguspark"
                width={180}
                height={64}
                style={{ height: 48, width: "auto", objectFit: "contain", background: "#fff", borderRadius: 8, padding: "6px 10px" }}
              />
              <span className="report-colophon__tag">data with purpose summit · organiser</span>
            </div>
            <div className="report-colophon__item">
              <Image
