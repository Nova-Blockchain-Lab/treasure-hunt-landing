...
import type { Snapshot, ReportTag } from "@/lib/datasummit-report"
import { fmtInt, fmtSeconds } from "@/lib/datasummit-report"
    ...
    <section className="report-section" id="tags">
      <div className="report-container">
        <Anchor
          num="03"
          title="TAGS"
          lede={`One row per in-play tag, ${tagList.length} total. Tags were hidden across the venue by players and organisers. Sortable and searchable, with a top-10 podium and ranked find-distribution curve framing the spread.`}
        />
            ...
            <div className="report-organic">
              ...
              <span>
                <strong style={{ fontWeight: 500 }}>
                  No reward boosts ran during Data with Purpose Summit — every
