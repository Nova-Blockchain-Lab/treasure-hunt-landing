    ...
    >
      ...
      <div className="report-hero__colophon" aria-hidden>
        <span className="report-hero__colophon-mark">
          ...
          <span>DATA WITH PURPOSE SUMMIT</span>
        </span>
        <span className="report-hero__colophon-sep" />
        <span className="report-hero__colophon-coords">TAGUSPARK · 2026</span>
        <span className="report-hero__colophon-sep" />
      ...
      >
        DATA WITH PURPOSE SUMMIT{dateRange ? ` · ${dateRange}` : ""} · TAGUSPARK
      </p>
      <p
